...
func get_need_upgrade_medal(id: int) -> int:
...
func check_upgrade_war_medal(id: int) -> bool:
	return get_war_medal_level(id) <= 2 and medal >= get_need_upgrade_medal(id)


func upgrade_war_medal(id: int) -> void:
...
func get_commander_data(data: CommanderData) -> void:
	data.rank = rank
