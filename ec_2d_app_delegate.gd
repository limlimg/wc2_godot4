...
func _ec_game_init(content_scale_width: int, content_scale_height: int, orientation: int, game_view_width: int, game_view_height: int) -> void:
	...
	state_manager.init()
	state_manager.register_state(load("res://c_logo_state.tscn").instantiate())
	state_manager.register_state(load("res://c_menu_state.tscn").instantiate())
	state_manager.register_state(load("res://c_load_state.tscn").instantiate())
	state_manager.register_state(load("res://c_game_state.tscn").instantiate())
