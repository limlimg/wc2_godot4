...
func set_background(image_name: StringName) -> void:
	texture_background = _s_texture_res.get_image(image_name)


func set_glow(image_name: StringName) -> void:
	texture_glow = _s_texture_res.get_image(image_name)
...
func set_text_image(image_name: StringName) -> void:
	texture_text_image = _s_texture_res.get_image(image_name)
