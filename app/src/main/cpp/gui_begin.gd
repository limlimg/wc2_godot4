...
func _on_update(_delta: float) -> void:
	...
	if country == null:
		return
	medal_soldiers = country.get_war_medal_level(_WarMedalId.INFANTRY_MEDAL)
	medal_airforce = country.get_war_medal_level(_WarMedalId.AIR_FORCE_MEDAL)
	medal_cannon = country.get_war_medal_level(_WarMedalId.ARTILLERY_MEDAL)
	medal_panzer = country.get_war_medal_level(_WarMedalId.ARMOUR_MEDAL)
	medal_navy = country.get_war_medal_level(_WarMedalId.NAVY_MEDAL)
	medal_honor = country.get_war_medal_level(_WarMedalId.COMMERCE_MEDAL)
