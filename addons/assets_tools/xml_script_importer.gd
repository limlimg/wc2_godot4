...
const _TutorialCmd = preload("res://app/src/main/cpp/imported_containers/tutorial_cmd.gd")
const _TutorialCmdList = preload("res://app/src/main/cpp/imported_containers/tutorial_cmd_list.gd")
