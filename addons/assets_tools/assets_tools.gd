...
var _IMPORTERS = [
	...
	preload("res://addons/assets_tools/xml_effect_importer.gd"),
	preload("res://addons/assets_tools/xml_generals_importer.gd"),
	preload("res://addons/assets_tools/xml_script_importer.gd"),
